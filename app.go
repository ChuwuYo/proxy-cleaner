...
func (a *App) DisableProxyViaPowerShell() string {
	...
	if err != nil {
		...
		return i18n.GetMessage(i18n.ErrExecutePowerShell, err.Error(), string(output))
	}
...
func (a *App) ResetSystemProxy() string {
	...
	output, err := cmd.CombinedOutput()
	if err != nil {
		return i18n.GetMessage(i18n.ErrResetProxy, err.Error(), string(output))
	}
...
func (a *App) FlushDNSCache() string {
	...
	output, err := cmd.CombinedOutput()
	if err != nil {
		return i18n.GetMessage(i18n.ErrFlushDNS, err.Error(), string(output))
	}
...
func (a *App) ResetTCPIP() string {
	...
	if err != nil {
		return i18n.GetMessage(i18n.ErrResetTCPIP, err.Error(), string(output))
	}
...
func (a *App) ResetWinsock() string {
	...
	if err != nil {
		return i18n.GetMessage(i18n.ErrResetWinsock, err.Error(), string(output))
	}
...
func (a *App) RestartDNSService() string {
	...
	if isRunning {
		...
		if err1 != nil {
			return i18n.GetMessage(i18n.ErrStopDNS, err1.Error(), string(out1))
		}
	}
	...
	if err2 != nil {
		return i18n.GetMessage(i18n.ErrStartDNS, err2.Error(), string(out2))
	}
...
func (a *App) ResetFirewall() string {
	...
	if err != nil {
		return i18n.GetMessage(i18n.ErrResetFirewall, err.Error(), string(output))
	}
...
func (a *App) ReleaseRenewIP() string {
	...
	if err1 != nil {
		return i18n.GetMessage(i18n.ErrReleaseIP, err1.Error(), string(output1))
	}
	...
	if err2 != nil {
		return i18n.GetMessage(i18n.ErrRenewIP, err2.Error(), string(output2))
	}
